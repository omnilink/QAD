...
from qad.qad_copy_maptool import *
...
class QadCOPYCommandClass(QadCommandClass):
    ...
    def getNote(self):
        ...
        return QadMsg.translate("Command_COPY",
    ...
    def waitForSecondPt(self):
        ...
        if len(self.featureCache) > 0:
            ...
            keyWords = QadMsg.translate("Command_COPY", "Array")
            prompt = QadMsg.translate("Command_COPY",
                                      "Specify second point or [{0}] <use first point as displacement from origin point 0,0>: ").format(
                keyWords)
        ...
        # RISPOSTA ALLA RICHIESTA PUNTO BASE (da step = 1)
            ...
            if type(value) == unicode:
                if value == QadMsg.translate("Command_COPY", "Displacement") or value == "Displacement":
                    ...
                    prompt = QadMsg.translate("Command_COPY", "Enter a copy mode option [{0}] <{1}>: ").format(keyWords,
                                                                                                               default)
