...
class QadMapTool(QgsMapTool):
        ...
        for layerEntitySet in entitySet.layerEntitySetList:
            ...
            if layer.type() == QgsMapLayer.VectorLayer and layer.isEditable():
                for featureId in layerEntitySet.featureIds:
                    ...
                    self.entitySetGripPoints.addEntity(entity, QadVariables.get(
                        QadMsg.translate("Environment variables", "GRIPS")))
                ...
                if isLastCmdToInsert:
                    ...
                    if isRecentMenuToInsert:
                        ...
                        recentCmdsMenu = popupMenu.addMenu(
                            QadMsg.translate("Popup_menu_graph_window", "Recent commands"))
    ...
    def runCmdFromPopupMenuOnGrip(self, virtualGripCommand, gripPoint):
        ...
        self.plugIn.runCommand("QadVirtualGripCommandsClass",
                               [virtualGripCommand, self.entitySetGripPoints, gripPoint.getPoint()])
                ...
                while nVertex < linearObjectList.qty():
                    ...
                    if gripPoint.isIntersecting(linearObject.getMiddlePt()):
                        ...
                        if linearObject.isSegment():  # linea
                            ...
                            action = QAction(msg, popupMenu)
                            f = lambda: self.runCmdFromPopupMenuOnGrip(QadVirtualGripCommandsEnum.LINE_TO_ARC,
                                                                       gripPoint)
                        else:  # arco
                            msg = QadMsg.translate("Popup_menu_grip_window", "Convert to line")
                            action = QAction(msg, popupMenu)
