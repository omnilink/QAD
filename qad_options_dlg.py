...
from qad.qad_options_ui import Ui_Options_Dialog

from qad.qad_variables import *
from qad.qad_msg import QadMsg, qadShowPluginHelp
import qad.qad_utils
from qad.qad_gripcolor_dlg import QadGripColorDialog
from qad.qad_windowcolor_dlg import QadColorContextEnum, QadColorElementEnum, QadWindowColorDialog
...
class QadOPTIONSDialog(QDialog, QObject, Ui_Options_Dialog):
    ...
    def init_display_tab(self):
        ...
        # SHOWTEXTWINDOW
        self.checkBox_SHOWTEXTWINDOW.setChecked(
            self.tempQadVariables.get(QadMsg.translate("Environment variables", "SHOWTEXTWINDOW")))
        ...
        self.checkBox_INPUTSEARCHOPTIONS_AUTOCOMPLETE.setChecked(
            inputSearchOptions & QadINPUTSEARCHOPTIONSEnum.AUTOCOMPLETE)
        self.checkBox_INPUTSEARCHOPTIONS_DISPLAY_LIST.setChecked(
            inputSearchOptions & QadINPUTSEARCHOPTIONSEnum.DISPLAY_LIST)
        self.checkBox_INPUTSEARCHOPTIONS_DISPLAY_ICON.setChecked(
            inputSearchOptions & QadINPUTSEARCHOPTIONSEnum.DISPLAY_ICON)
        self.checkBox_INPUTSEARCHOPTIONS_EXCLUDE_SYS_VAR.setChecked(
            inputSearchOptions & QadINPUTSEARCHOPTIONSEnum.EXCLUDE_SYS_VAR)
        ...
        circleMinSegmentQty = self.tempQadVariables.get(
        ...
        tolerance2ApproxCurve = self.tempQadVariables.get(
    ...
    def accept_display_tab(self):
        ...
        self.tempQadVariables.set(QadMsg.translate("Environment variables", "INPUTSEARCHOPTIONS"),
                                  newInputSearchOptions)
        ...
        self.tempQadVariables.set(QadMsg.translate("Environment variables", "TOLERANCE2APPROXCURVE"),
    ...
    def lineEdit_CMDINPUTHISTORYMAX_Validation(self):
        return self.intLineEditWidgetValidation(self.lineEdit_CMDINPUTHISTORYMAX, \
                                                ...
                                                QadMsg.translate("Options_Dialog",
                                                                 "Invalid maximum command history length"))
    ...
    def lineEdit_ARCMINSEGMENTQTY_Validation(self):
        return self.intLineEditWidgetValidation(self.lineEdit_ARCMINSEGMENTQTY, \
                                                ...
                                                QadMsg.translate("Options_Dialog",
                                                                 "Invalid minimum number of segments in an arc"))
    ...
    def lineEdit_CIRCLEMINSEGMENTQTY_Validation(self):
        return self.intLineEditWidgetValidation(self.lineEdit_CIRCLEMINSEGMENTQTY, \
                                                QadMsg.translate("Environment variables", "CIRCLEMINSEGMENTQTY"), \
                                                QadMsg.translate("Options_Dialog",
                                                                 "Invalid minimum number of segments in a circle"))
    ...
    def lineEdit_TOLERANCE2APPROXCURVE_Validation(self):
        return self.floatLineEditWidgetValidation(self.lineEdit_TOLERANCE2APPROXCURVE, \
                                                  QadMsg.translate("Environment variables", "TOLERANCE2APPROXCURVE"), \
                                                  QadMsg.translate("Options_Dialog",
                                                                   "Invalid tolerance between real and segmented curve"))
    ...
    def Button_TextWindowColor_clicked(self):
        Form = QadWindowColorDialog(self.plugIn, self, QadColorContextEnum.COMMAND_LINE,
                                    QadColorElementEnum.COMMAND_HISTORY_BACKGROUND)
    ...
    def init_drafting_tab(self):
        ...
        self.previewAutoSnapMarker = QadPreviewAutoSnapMarker(self.plugIn, autoSnapColor,
                                                              self.widget_AUTOSNAPSIZE.parent())
        ...
        self.previewAperture = QadPreviewAperture(self.plugIn, apertureColor, cursorColor,
                                                  self.widget_APERTURESIZE.parent())
    ...
    def accept_drafting_tab(self):
        ...
        # AUTOSNAPSIZE
        self.tempQadVariables.set(QadMsg.translate("Environment variables", "AUTOSNAPSIZE"),
                                  self.horizontalSlider_AUTOSNAPSIZE.value())
        ...
        # APERTURE
        self.tempQadVariables.set(QadMsg.translate("Environment variables", "APERTURE"),
                                  self.horizontalSlider_APERTURE.value())
    ...
    def Button_AutoSnapWindowColor_clicked(self):
        Form = QadWindowColorDialog(self.plugIn, self, QadColorContextEnum.MODEL_SPACE_2D,
                                    QadColorElementEnum.AUTOSNAP_MARKER)
    ...
    def init_selection_tab(self):
        ...
        # PICKFIRST
        pickFirst = False if self.tempQadVariables.get(
            QadMsg.translate("Environment variables", "PICKFIRST")) == 0 else True
        ...
        # GRIPMULTIFUNCTIONAL
        gripMultiFunctional = self.tempQadVariables.get(
            QadMsg.translate("Environment variables", "GRIPMULTIFUNCTIONAL"))
        self.checkBox_GRIPMULTIFUNCTIONAL_ON_DYNAMIC_MENU_AND_HOT_GRIPT.setChecked(
            gripMultiFunctional & QadGRIPMULTIFUNCTIONALEnum.ON_DYNAMIC_MENU_AND_HOT_GRIPT)
    ...
    def accept_selection_tab(self):
        # PICKBOX
        self.tempQadVariables.set(QadMsg.translate("Environment variables", "PICKBOX"),
                                  self.horizontalSlider_PICKBOX.value())
        ...
        # GRIPSIZE
        self.tempQadVariables.set(QadMsg.translate("Environment variables", "GRIPSIZE"),
                                  self.horizontalSlider_GRIPSIZE.value())
    ...
    def lineEdit_GRIPOBJLIMIT_Validation(self):
        return self.intLineEditWidgetValidation(self.lineEdit_GRIPOBJLIMIT, \
                                                ...
                                                QadMsg.translate("Options_Dialog",
                                                                 "Invalid object selection limit for display of grips"))
