...
from qad.qad_mirror_maptool import *
...
class QadMIRRORCommandClass(QadCommandClass):
    ...
    def mirrorGeoms(self):
        ...
        for layerEntitySet in entitySet.layerEntitySetList:
            ...
            while len(layerEntitySet.featureIds) > 0:
                ...
                if self.mirror(f, transformedBasePt, transformedNewPt, rotFldName, layerEntitySet, entitySet,
                               dimEntity) == False:
                    self.plugIn.destroyEditCommand()
                    return
    ...
    def run(self, msgMapTool=False, msg=None):
        ...
        # RISPOSTA ALLA RICHIESTA SECONDO PUNTO PER SPECCHIO (da step = 2)
            ...
            prompt = QadMsg.translate("Command_MIRROR", "Erase source objects ? [{0}] <{1}>: ").format(keyWords,
                                                                                                       default)
