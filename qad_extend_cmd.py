...
class QadEXTENDCommandClass(QadCommandClass):
    ...
    def waitForObjectSel(self):
        ...
        prompt = QadMsg.translate("Command_EXTEND",
                                  "Select the object to extend or shift-select to trim or [{0}]: ").format(keyWords)
        ...
        # RISPOSTA ALLA SELEZIONE OGGETTI DA ESTENDERE
            ...
            if type(value) == unicode:
                if value == QadMsg.translate("Command_EXTEND", "Fence") or value == "Fence":
                    ...
                    prompt = QadMsg.translate("Command_EXTEND", "Specify an extension mode [{0}] <{1}>: ").format(
