            ...
            while atPart >= 0:
                ...
                if qad_utils.ptNear(pt, point):  # cambio punto iniziale
                    ...
                    if linearObject.isSegment():
                        ...
                        distFromMiddleChord = qad_utils.getDistance(middlePt,
                                                                    qad_utils.getPerpendicularPointOnInfinityLine(
                                                                        oldArc.getStartPt(), oldArc.getEndPt(),
                                                                        middlePt))
                        ...
                        if linearObject.isInverseArc():
                            ...
                            middlePt = qad_utils.getPolarPointByPtAngle(middlePt, \
                                                                        qad_utils.getAngleBy2Pts(pt,
                                                                                                 oldArc.getStartPt()) + math.pi / 2, \
                                                                        distFromMiddleChord)
...
def gripStretchQgsLineStringGeometry(geom, basePt, ptListToStretch, offSetX, offSetY, tolerance2ApproxCurve):
    ...
    while atPart < linearObjectListToStretch.qty():
        ...
        if linearObject.isSegment():
            ...
            newArc, newInverseFlag = gripStretchArc(linearObject.getArc(), ptListToStretch, offSetX, offSetY, tolerance,
                                                    linearObject.isInverseArc())
            if newArc is None:
                return None
