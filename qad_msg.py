...
class QadMsgClass:
    ...
    # translate
    # ============================================================================
    # TODO: encoding is not used any more, as QCoreApplication.translate removed the parameter. Will need to remove the
    # parameter from the code totally later. Currently encoding has been changed from QCoreApplication.UnicodeUTF8 to None as default.
    def translate(self, context, sourceText, disambiguation=None, encoding=None, n=-1):
