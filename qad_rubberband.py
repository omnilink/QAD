...
def getColorForWindowSelectionArea():
    ...
    if QadVariables.get(QadMsg.translate("Environment variables", "SELECTIONAREA")) == 0:
        ...
        opacity = QadVariables.get(
            QadMsg.translate("Environment variables", "SELECTIONAREAOPACITY"))  # 0 = trasparente [0-100]
...
class QadRubberBand():
    def __init__(self, mapCanvas, alternativeBand=False, borderColor=None, fillColor=None):
        ...
        self.__rubberBandPolygon = createRubberBand(self.mapCanvas, QGis.Polygon, alternativeBand, borderColor,
                                                    fillColor)
