...
class QadEntity():
    ...
    def gripStretch(self, basePt, ptListToStretch, offSetX, offSetY, tolerance2ApproxCurve):
        ...
        return qad_stretch_fun.gripStretchQadGeometry(self.qadGeom, basePt, ptListToStretch, offSetX, offSetY,
        ...
        for layerEntitySet in self.layerEntitySetList:
            ...
            if partial is not None:
                ...
                if result is None:
                    ...
                    result.combineExtentWith(
                        QgsRectangle(coordTransform.transform(partial.xMinimum(), partial.yMinimum()), \
                                     coordTransform.transform(partial.xMaximum(), partial.yMaximum())))
        return result
