...
class QadUNDOCommandClass(QadCommandClass):
    ...
    def run(self, msgMapTool=False, msg=None):
        ...
        if self.step == 0:  # inizio del comando
            ...
            default = 1
            prompt = QadMsg.translate("Command_UNDO", "Enter the number of operations to undo or [{0}] <{1}>: ").format(
            ...
            if type(value) == unicode:
                if value == QadMsg.translate("Command_UNDO", "BEgin") or value == "BEgin":
                    ...
                    if self.plugIn.getPrevBookmarkPos() == -1:  # non ci sono bookmark precedenti
                        ...
                        prompt = QadMsg.translate("Command_UNDO", "This will undo everything. OK ? <{0}>: ").format(
                            default)
