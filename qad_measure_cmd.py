...
class QadMEASURECommandClass(QadCommandClass):
    ...
    def connectQAction(self, action):
        action.triggered = self.plugIn.runMEASURECommand
    ...
    def getNote(self):
        ...
        return QadMsg.translate("Command_MEASURE",
    ...
    def waitForAlignmentObjs(self):
        ...
        prompt = QadMsg.translate("Command_MEASURE", "Align with object ? [{0}] <{1}>: ").format(keyWords,
                                                                                                 self.defaultValue)
