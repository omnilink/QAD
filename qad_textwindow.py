...
from qad.qad_ui_textwindow import Ui_QadTextWindow, Ui_QadCmdSuggestWindow
from qad.qad_msg import QadMsg
import qad.qad_utils
from qad.qad_snapper import *
from qad.qad_variables import QadVariables, QadINPUTSEARCHOPTIONSEnum
...
class QadTextWindow(QDockWidget, Ui_QadTextWindow, object):
    ...
    def refreshColors(self):
        history_ForegroundColor = QColor(
            QadVariables.get(QadMsg.translate("Environment variables", "CMDHISTORYFORECOLOR")))
        history_BackGroundColor = QColor(
            QadVariables.get(QadMsg.translate("Environment variables", "CMDHISTORYBACKCOLOR")))
        ...
        upperKeyWord_ForegroundColor = QColor(
            QadVariables.get(QadMsg.translate("Environment variables", "CMDLINEOPTCOLOR")))
        KeyWord_BackgroundColor = QColor(
            QadVariables.get(QadMsg.translate("Environment variables", "CMDLINEOPTBACKCOLOR")))
        highlightKeyWord_BackGroundColor = QColor(
            QadVariables.get(QadMsg.translate("Environment variables", "CMDLINEOPTHIGHLIGHTEDCOLOR")))
        self.edit.set_keyWordColors(KeyWord_BackgroundColor, upperKeyWord_ForegroundColor,
                                    highlightKeyWord_BackGroundColor)
...
class QadCmdSuggestWindow(QWidget, Ui_QadCmdSuggestWindow, object):
    ...
    def show(self, mode=True, filter=""):
        if mode == True:
            ...
            if inputSearchOptions & QadINPUTSEARCHOPTIONSEnum.ON and (
            not inputSearchOptions & QadINPUTSEARCHOPTIONSEnum.EXCLUDE_SYS_VAR):
